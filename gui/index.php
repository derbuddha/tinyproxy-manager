        ...
        async function refreshTraffic() {
            try {
                ...
                filteredTraffic.forEach(item => {
                    ...
                    const methodClass = isBlocked ? 'method-blocked' : 'method-' + item.method.toLowerCase();
                    const itemClass = isBlocked ? 'traffic-item blocked' : 'traffic-item';
